...
try {
    ...
    //         echo "<small>Sorry Password is to Short</small>";
    //     } else {
    //     }
    // }
    ...
    if (isset($_POST['btn'])) {
        if ($_POST['password'] == $_POST['confirmpassword']) {
            ...
            // {
            //     if (mysqli_errno($_POST['email']) == 1062) {
            ...
            $q = $pdo->prepare("INSERT INTO users1 (name,email,password,gender,dob) VALUES (:name, :email, :password, :gender, :dob)");
...
<body>
    ...
    <form action="signup.php" method="POST" class="m-auto col-4">
        <div class="form-group">
            ...
            <small id="helpId" class="form-text text-danger"><?php if (isset($error['name'])) {
                                                                    echo $error['name'];
                                                                } ?></small>
        </div>
        <!-- <div class="form-group">
